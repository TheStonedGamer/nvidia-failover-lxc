...
| `PROXY_SERVING_WINDOW_S` | `20` | how long (seconds) after its last content delta a model still counts as "currently serving" for the dashboard's green dot before it falls back to marking the head-of-ladder rung |
